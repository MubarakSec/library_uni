    ...
    if (paginatedBooks.length === 0) {
      ...
      paginatedBooks.forEach((book) => {
        ...
        if (book.badge) {
          ...
          badgeDiv.className = "book-badge";
          badgeDiv.textContent = book.badge;
        ...
        authorSpan.innerHTML = '<i class="fas fa-user"></i> ';
        authorSpan.appendChild(document.createTextNode(book.author));
        metaDiv.appendChild(authorSpan);

        const yearSpan = document.createElement("span");
        yearSpan.innerHTML = '<i class="fas fa-calendar-alt"></i> ';
        yearSpan.appendChild(document.createTextNode(book.year));
        metaDiv.appendChild(yearSpan);

        const downloadsSpan = document.createElement("span");
        downloadsSpan.innerHTML = '<i class="fas fa-download"></i> ';
        downloadsSpan.appendChild(document.createTextNode(book.downloads));
        metaDiv.appendChild(downloadsSpan);

        const ratingSpan = document.createElement("span");
        ratingSpan.innerHTML = '<i class="fas fa-star"></i> ';
        ratingSpan.appendChild(document.createTextNode(book.rating));
        ...
        previewBtn.className = "btn small-btn";
